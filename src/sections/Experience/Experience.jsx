...
const EXPERIENCES = [
  {
    ...
    isCurrent: true,
    achievements: [
      "System Architecture: Architecting modular RESTful APIs using Node.js/Express, ensuring high availability and service maintainability.",
      "Data Engineering: Owning the MongoDB schema design process, implementing strategic indexing and aggregation pipelines to optimize retrieval speeds.",
      "Security Protocols: Implementing enterprise-grade security layers, including JWT-based stateless authentication and multi-tier Role-Based Access Control (RBAC).",
      "Engineering Lifecycle: Driving feature delivery within Agile sprints, contributing to technical documentation, and maintaining high code standards through rigorous peer reviews.",
    ],
